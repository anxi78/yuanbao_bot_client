...
# 从配置文件导入
from config1 import APP_KEY, APP_SECRET, API_DOMAIN, WS_URL
                        ...
                        if cmd == "inbound_message" and biz_data:
                            try:
                                ...
                                cache_entry = {
                                    ...
                                    "content": push_json.get("text", "") or push_json.get("content", ""),
